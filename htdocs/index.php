...
<div class="content">
    ...
    <div class="features">
        <div class="feature">
            <img src="/assets/images/innovation.jpg" alt="Innovation Icon">
            <h3>Innovation</h3>
            <p>Cutting-edge solutions using the latest technologies</p>
        </div>
        <div class="feature">
            <img src="/assets/images/expertise.jpg" alt="Expertise Icon">
            <h3>Expertise</h3>
            <p>Team of skilled professionals with deep industry knowledge</p>
        </div>
        <div class="feature">
            <img src="/assets/images/results.jpg" alt="Results Icon">
            <h3>Results</h3>
            <p>Proven track record of successful project deliveries</p>
        </div>
        <div class="feature">
            <img src="/assets/images/reliability.jpg" alt="Reliability Icon">
            <h3>Reliability</h3>
            <p>Dependable solutions and ongoing support for your business</p>
        </div>
        <div class="feature">
            <img src="/assets/images/scalability.jpg" alt="Scalability Icon">
            <h3>Scalability</h3>
            <p>Solutions that grow with your business needs</p>
        </div>
        <div class="feature">
            <img src="/assets/images/customer-focus.jpg" alt="Customer Focus Icon">
...
.feature {
    ...
    min-height: 300px; /* taller to fit bigger image */
    display: flex;
...
.feature img {
    ...
    margin-bottom: 20px;
    object-fit: cover;    /* crop/scale image neatly */
    box-shadow: 0 12px 25px rgba(0,0,0,0.15); /* modern shadow */
    transition: transform 0.3s, box-shadow 0.3s;
}
