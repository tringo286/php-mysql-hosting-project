...
<div class="hero">
    ...
    <p>User-centered product and interface design.</p>
    <img src="/assets/images/product7.svg" alt="<?php echo htmlspecialchars($productName); ?>" style="max-width:100%; margin-top:18px; border-radius:8px;">
</div>
<div class="content">
    <h2>Overview</h2>
    <p>Design sprints, user research, and polished interfaces.</p>
</div>
