...
<div class="hero">
    ...
    <p>Conversational AI solutions for support and automation.</p>
    <img src="/assets/images/product9.svg" alt="<?php echo htmlspecialchars($productName); ?>" style="max-width:100%; margin-top:18px; border-radius:8px;">
</div>
<div class="content">
    <h2>Overview</h2>
    <p>Build intelligent chat experiences across channels.</p>
</div>
